$(function () {
    ...
    $('#tree-list_2 a').css('color', 'orange');
    /*导航标签切换样式*/
    ...
    $('#table2').bootstrapTable({
        ...
        columns: [
            ...
            {field: "user_company", title: "分类", align: "center", valign: "middle", sortable: "true"},
            {field: "user_dates", title: "代码", align: "center", valign: "middle", sortable: "true"},
            {field: "user_lastlogintime", title: "发生频率", align: "center", valign: "middle", sortable: "true"},
            {field: "user_version", title: "发生面积", align: "center", valign: "middle", sortable: "true"},
            {field: "user_isv2", title: "面积比例", align: "center", valign: "middle", sortable: "true"},
        ],
        data: [
            {
                "user_email": "1",
                "user_company": "少发去",
                "user_dates": "01",
                "user_lastlogintime": "6.23",
                "user_version": "21345.32",
                "user_isv2": "40",
            },

            {
                ...
                "user_company": "轻易发区",
                "user_dates": "02",
                "user_lastlogintime": "5.36",
                "user_version": "39641.01",
                "user_isv2": "25",
            },

            {
                ...
                "user_company": "易发区",
                "user_dates": "03",
                "user_lastlogintime": "3.16",
                "user_version": "31694.45",
                "user_isv2": "21",
            },

            {
                ...
                "user_company": "频发区",
                "user_dates": "04",
                "user_lastlogintime": "1.05",
                "user_version": "22913.26",
                "user_isv2": "14",
            },
